first_day_result = int(input('Введите кол-во км, которое пробежал спортсмен в 1-й день - '))
last_day_result = int(input('Введите кол-во км, которое пробежал спортсмен в последний день - '))
